...
const (
	ModelService_GetList_FullMethodName    = "/receiptpb.v1.ModelService/GetList"
	ModelService_GetItem_FullMethodName    = "/receiptpb.v1.ModelService/GetItem"
	ModelService_CreateItem_FullMethodName = "/receiptpb.v1.ModelService/CreateItem"
	ModelService_UpdateItem_FullMethodName = "/receiptpb.v1.ModelService/UpdateItem"
	ModelService_DeleteItem_FullMethodName = "/receiptpb.v1.ModelService/DeleteItem"
)
...
var ModelService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "receiptpb.v1.ModelService",
	...
	Metadata: "receiptpb/v1/receipt.proto",
}
